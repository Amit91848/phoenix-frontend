    ...
    <div className="flex">
      <div className="flex justify-center items-center w-1/2 h-screen">
        ...
        <div className="flex flex-col h-fit w-4/5 items-center ">
          ...
          <div className="flex w-3/5 flex-col justify-between item-center mt-5">
            <input
              type="text"
              placeholder="Email"
              name="email"
          ...
          <div className="flex w-3/5 mt-7">
            <button onClick={handleSubmit} className="border bg-loginBlue  w-full h-9 rounded-lg text-white text-sm">Login</button>
          </div>

          <div className="flex mt-3 w-3/5 text-sm justify-center">
            Don't have an account <p className="text-loginBlue underline ml-2 hover:cursor-pointer"><Link to='/Signup'> Signup </Link></p>
          </div>
        </div>
      </div>
